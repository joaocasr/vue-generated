<template>
    <div class="grid-container">
        ...
        <p class="grid-item txt3">The page you are looking for doesn't exist. Return to PrincipalPage</p>
        <button @click="returntopage" class="grid-item btn1">PrincipalPage</button>
        </div>
    </div>
  </template>
<script>
