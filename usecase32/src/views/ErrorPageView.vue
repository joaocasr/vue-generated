<template>
    <div class="grid-container">
        ...
        <p class="grid-item txt3">The page you are looking for doesn't exist. Return to FirstPage</p>
        <button @click="returntopage" class="grid-item btn1">FirstPage</button>
        </div>
    </div>
  </template>
<script>
